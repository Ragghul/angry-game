...
var box1, pig1,pig3;
var platform;
var bird, slingshot,b1,b2,ground,ground1,polygon;
...
function setup(){
    ...
    ground1 = new Ground(650,350,300,10);
    ground2 = new Ground(1015,250,300,10);
  ...
  // log1 = new Log(810,260,300, PI/2);
   ...
   box4 = new Box(600,250,60,60);
   box5 = new Box(700,250,60,60);
   box6 = new Box(650,190,70,70);

   box7 = new Box(900,240,50,50);
   box8 = new Box(1000,240,50,50);
   box9 = new Box(1100,240,50,50);
   box10 = new Box(950,190,60,60);
   box11 = new Box(1050,190,60,60);
